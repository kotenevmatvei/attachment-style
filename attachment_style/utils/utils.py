...
def build_ecr_r_chart(anxious_score: float, secure_score: float, avoidant_score: float):
    ...
    fig.add_annotation(x=scale_min, y=scale_min + 0.4, text="<i>secure</i>", showarrow=False, xanchor="right", font=style_label_font_style)
    fig.add_annotation(x=scale_max, y=scale_min + 0.4, text="<i>preoccupied</i>", showarrow=False, xanchor="left", font=style_label_font_style)
    fig.add_annotation(x=scale_min, y=scale_max - 0.4, text="<i>dismissive</i>", showarrow=False, xanchor="right", font=style_label_font_style)
    fig.add_annotation(x=scale_max, y=scale_max - 0.4, text="<i>fearful-avoidant</i>", showarrow=False, xanchor="left", font=style_label_font_style)
    ...
    fig.add_shape(type="line", x0=xp, y0=yp, x1=proj_anxiety_x, y1=proj_anxiety_y, line=projection_line_style)
    fig.add_trace(go.Scatter(x=[proj_anxiety_x], y=[proj_anxiety_y], mode="markers", marker=dict(color=projection_line_style["color"], size=5, symbol="circle-open"), hoverinfo='none'))


    # Projection to Avoidance Axis (vertical line at x=scale_mid)
    proj_avoidance_x = scale_mid
    proj_avoidance_y = yp
    fig.add_shape(type="line", x0=xp, y0=yp, x1=proj_avoidance_x, y1=proj_avoidance_y, line=projection_line_style)
    fig.add_trace(go.Scatter(x=[proj_avoidance_x], y=[proj_avoidance_y], mode="markers", marker=dict(color=projection_line_style["color"], size=5, symbol="circle-open"), hoverinfo='none'))
    ...
    proj_diag_x = (xp + yp) / 2
    proj_diag_y = (xp + yp) / 2
    fig.add_shape(type="line", x0=xp, y0=yp, x1=proj_diag_x, y1=proj_diag_y, line=projection_line_style)
    fig.add_trace(go.Scatter(x=[proj_diag_x], y=[proj_diag_y], mode="markers", marker=dict(color=projection_line_style["color"], size=5, symbol="circle-open"), hoverinfo='none'))
