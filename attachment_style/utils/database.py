...
def upload_to_db(
    ...
    if len(values) == 36:
        result_object = AssessYourself(
            ...
            test=test,
            age=personal_answers.get("age", 0),
            relationship_status=personal_answers.get("relationship_status", ""),
            gender=personal_answers.get("gender", ""),
            therapy_experience=personal_answers.get("therapy_experience", ""),
            anxious_q1=values[0],
            anxious_q2=values[1],
            anxious_q3=values[2],
            anxious_q4=values[3],
