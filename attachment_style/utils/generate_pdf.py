...
def generate_report(answers: dict[str, tuple[str, float, str]]) -> None:
    ...
    doc = SimpleDocTemplate("attachment_style/data/attachment style report.pdf", topMargin=top_margin)
    ...
    # add chart
    chart = Image("attachment_style/data/figure.png", width=700 / 2, height=500 / 2)
    story.append(chart)
