...
class TestYourself(Base):
    ...
    anxioius_q1: Mapped[int]
    anxioius_q2: Mapped[int]
    anxioius_q3: Mapped[int]
    anxioius_q4: Mapped[int]
    anxioius_q5: Mapped[int]
    anxioius_q6: Mapped[int]
    anxioius_q7: Mapped[int]
    anxioius_q8: Mapped[int]
    anxioius_q9: Mapped[int]
    anxioius_q10: Mapped[int]
    anxioius_q11: Mapped[int]
    anxioius_q12: Mapped[int]
    anxioius_q13: Mapped[int]
    anxioius_q14: Mapped[int]
